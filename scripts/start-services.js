...
const services = [
  { name: 'billing', command: 'node nest start billing --watch', port: ports.BILLING_CLIENT_PORT },
  { name: 'address', command: 'node nest start address --watch', port: ports.ADDRESS_CLIENT_PORT },
  { name: 'auth', command: 'node nest start auth --watch', port: ports.AUTH_CLIENT_PORT },
  { name: 'forms', command: 'node nest start forms --watch', port: ports.FORMS_CLIENT_PORT },
];
